...
SalleService salleService = new SalleService();
    ...
    //Salle s2 = new Salle("Gym poommm", "20 Sidi-Hassin", "Salle équipée", "+21655053765", "gym@example.com");
       // Salle s3 = new Salle("Gym go", "20 Sidi-Hassin", "Salle équipée", "+21655053765", "gym@example.com");
       // Salle s4=new Salle (4,"Gym poromax", "20 Sidi-Hassine", "Salle équipée", "+21655053765", "gym@example.com");
        ...
        //Abonnement ab5 = new Abonnement(6,Date.valueOf("2025-03-11"), Date.valueOf("2026-04-11"),
               // année);
        //Abonnement ab6 = new Abonnement(Date.valueOf("2025-03-17"), Date.valueOf("2026-04-16"),
                //année);
        //try {
//classe Salle
          ...
          //System.out.println(salleService.afficher(s2));
            //salleService.supprimer(4);



          //abonnementService.ajouter(ab2,4);
           // abonnementService.ajouter(ab2,3);
           // abonnementService.ajouter(ab1,3);
            //abonnementService.ajouter(ab3,3);
            //abonnementService.ajouter(ab3,1);
            //abonnementService.ajouter(ab1,1);
            //abonnementService.ajouter(ab2,1);
