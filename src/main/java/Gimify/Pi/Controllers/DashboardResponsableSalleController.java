...
public class DashboardResponsableSalleController {
    ...
    private void listUsersInVBox() {
        ...
        try {
            ...
            if ("Responsable_Salle".equals(currentUser.getRole())) {
                users = serviceUser.afficherPourResponsable(); // ✅ Nouvelle méthode pour les responsables
            } else {
                users = serviceUser.afficher(); // ✅ Méthode normale pour Admin
            }
    ...
    private HBox creerHBoxUtilisateur(User user) {
        ...
        hbox.setPadding(new Insets(11, 15, 20, 5));
